...
from llm.tool.tool_genaiclient import ToolGenAIClient
from llm.base.base_genaiclient import ChatClient
...
class ToolAgent:
    def __init__(self, base_url="http://localhost:11434", model="qwen2.5:32b", temperature=0.0, stream=False, process_multi_tool = True):
        ...
        self.llamaclient = ToolGenAIClient(base_url=base_url, model=model, temperature=temperature, stream=stream)
